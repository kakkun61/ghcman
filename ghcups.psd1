...
FunctionsToExport = @('Set-Ghc', 'Clear-Ghc', 'Install-Ghc', 'Uninstall-Ghc', 'Show-Ghc', 'Set-Cabal', 'Clear-Cabal', 'Install-Cabal', 'Uninstall-Cabal', 'Show-Cabal', 'Write-GhcupsConfigTemplate')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        # このモジュールのライセンスの URL。
        LicenseUri = 'https://github.com/kakkun61/ghcups/blob/1.0.1/LICENSE'
        ...
        ReleaseNotes = 'https://github.com/kakkun61/ghcups/blob/1.0.1/ChangeLog.md'
