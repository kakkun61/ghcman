...
FunctionsToExport = @('Set-Ghc', 'Get-Ghc', 'Clear-Ghc', 'Install-Ghc', 'Uninstall-Ghc', 'Show-Ghc', 'Set-Cabal', 'Get-Cabal', 'Clear-Cabal', 'Install-Cabal', 'Uninstall-Cabal', 'Show-Cabal', 'Write-GhcmanConfigTemplate', 'Show-GhcmanConfig', 'Get-GhcmanConfig', 'Update-GhcmanVersionFile')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        # このモジュールのライセンスの URL。
        LicenseUri = 'https://github.com/kakkun61/ghcman/blob/4.6/LICENSE'
        ...
        ReleaseNotes = 'https://github.com/kakkun61/ghcman/blob/4.6/ChangeLog.md'
